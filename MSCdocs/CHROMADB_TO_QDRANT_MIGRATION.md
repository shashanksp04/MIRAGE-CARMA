# Migrating MIRAGE-CARMA from ChromaDB to Qdrant
...
This document is a comprehensive, file-by-file migration guide for replacing ChromaDB with Qdrant as the vector database backend in the MIRAGE-CARMA project.  
